...
int main(void){
	...
	cout<<"Grazie alla sua eta' e alla sua saggezza, e' in grado di risolvere qualsiasi tipo di enigma, anche i più complicati!\n";  
	cout<<"  Astuzia=5 Agilita'=1 Coraggio=3\n";
	cout<<endl;
	cout<<"-Melany: una ragazzina dolce e innocente….all’apparenza! In realta' Melany ha un grande coraggio,\n";
	...
	cout<<"Con la sua intelligenza, nulla, nemmeno il più difficile degli indovinelli puo' fermarlo...\n";
